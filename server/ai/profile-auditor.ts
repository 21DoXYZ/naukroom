...
- Bio СТРОГО ≤150 символів (Instagram-ліміт), без хештегів, з чітким CTA у кожному варіанті. Порахуй символи перед видачею.
...
Зроби аудит Instagram-профілю. Поверни JSON:
{
  ...
  try {
    const result = JSON.parse(text) as ProfileAudit
