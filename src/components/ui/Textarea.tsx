    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          id={inputId}
          className={clsx(
            'w-full rounded-[8px] border px-3 py-2.5 text-[0.9375rem] fw-330 tracking-[-0.1px] bg-white transition-colors resize-none',
            'placeholder:text-[rgba(0,0,0,0.35)] leading-[1.55]',
            error
